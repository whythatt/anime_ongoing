...
<template>
  <div class="main">
    ...
    <div class="bottom-links">
      ...
      <RouterLink to="/forgot" class="forgot-pass">Forgot password?</RouterLink>
    </div>
...
.email,
.password {
  background-color: rgba(116, 140, 58, 0.7);
  width: 330px;
  height: fit-content;
  padding: 18px;
  border-radius: 10px;
